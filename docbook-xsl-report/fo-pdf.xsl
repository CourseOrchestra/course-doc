...
<xsl:stylesheet version="1.0"
	...
	<xsl:template name="pickfont-sans">
		<xsl:text>Calibri,Arial Unicode MS,Helvetica,serif,Georgia,Times New Roman</xsl:text>
	</xsl:template>

	<xsl:template name="pickfont-serif">
		<xsl:text>Cambria,Arial Unicode MS,Helvetica,serif,Georgia,Times New Roman</xsl:text>
	</xsl:template>
	...
	<!-- My Table Mods -->
	<xsl:param name="met.table.font.size">0.85</xsl:param>
	<!--  -->
	<xsl:param name="met.table.head.font.size">0.85</xsl:param>
